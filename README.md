...
- 公開頁、問卷與管理後台共用一套 Bauhaus 構成主義與紙本手稿語彙的高對比響應式設計系統：暖象牙紙張、近黑墨色及克制的紅、藍、黃幾何標記，搭配粗框、硬位移陰影、低幅度不規則圓角與少量手寫註記，全站不使用漸層或柔和漂浮陰影。公開頁可提高視覺表現，問卷維持紙張式易讀結構，後台則以較克制的建築資訊表風格保留密度與操作效率。所有介面保留鍵盤焦點、行動版觸控區、320px 題目換行與無 JavaScript 時的內容可見性。
