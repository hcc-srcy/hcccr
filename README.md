...
- 全站已完成版面級 UI 重構，不只替換色彩或按鈕：公開頁採編輯海報式非對稱網格，首頁以大字敘事、新竹實景、幾何構成與成果資訊板組成；調查索引與作答頁採紙本工作軸；管理後台採固定黑色工作列、非對稱 KPI 資訊板、方正資料表與紙張式編輯器。三套介面分別由 `main.css`、`surveys.css`、`admin.css` 維護，共用 Bauhaus 紅、藍、黃、暖象牙與近黑設計變數，不使用漸層或柔和漂浮陰影，也不保留舊版覆蓋層。所有介面保留鍵盤焦點、行動版觸控區、320px 題目換行與無 JavaScript 時的內容可見性。
