...
- 公開頁、問卷與管理後台共用同一套高對比響應式設計系統：以冷白、石墨黑與科技青綠建立企業品牌基礎，輔以少量電藍和訊號黃，透過精準格線、細邊框與低圓角呈現新竹科技意象，全站不使用漸層。首頁依主視覺與成果統計、進行中調查、代表團使命與參與入口、常見問題編排，後台則採企業 SaaS 工作區的緊密資訊密度。所有介面保留鍵盤焦點、行動版觸控區、320px 題目換行與無 JavaScript 時的內容可見性。
