...
- 公開頁、問卷與管理後台共用同一套高對比響應式設計系統：以白色、炭黑、青綠、珊瑚與黃色建立公共服務的編輯式視覺；首頁依主視覺與成果統計、進行中調查、代表團使命與參與入口、常見問題編排，後台則採較緊密的工作區密度。所有介面保留鍵盤焦點、行動版觸控區、320px 題目換行與無 JavaScript 時的內容可見性。
