(async function () {
  ...
  try {
    ...
    root.innerHTML = `
      ...
      <div class="kpi-strip"><div class="kpi"><span class="kpi__label">送出時間</span><strong class="kpi__value kpi__value--compact">${window.HCCCR.formatDate(submission.submitted_at, true)}</strong></div><div class="kpi"><span class="kpi__label">作答時間</span><strong class="kpi__value kpi__value--compact">${window.HCCCR.formatDuration(submission.duration_seconds)}</strong></div><div class="kpi"><span class="kpi__label">條款同意</span><strong class="kpi__value kpi__value--compact">${submission.agreed_terms ? "已同意" : "未記錄"}</strong></div><div class="kpi"><span class="kpi__label">資料模式</span><strong class="kpi__value kpi__value--compact">${window.HCCCR_DATA.mode === "demo" ? "示範" : "正式"}</strong></div></div>
