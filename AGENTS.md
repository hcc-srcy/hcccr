...
- **介面系統**：`main.css` 定義全站設計變數與公開元件，`surveys.css`、`admin.css` 分別負責問卷工作區與管理工作區；三份樣式須各自維持單一來源，不得在檔尾疊加另一套舊版覆蓋層。視覺採 Bauhaus 構成主義與紙本手稿的混合語彙，以暖象牙紙張、近黑墨色及克制的紅、藍、黃幾何標記建立品牌，搭配粗框、硬位移陰影、低幅度不規則圓角與少量手寫註記，不使用漸層、柔和漂浮陰影、裝飾性光球或大面積圓角卡片。公開頁使用編輯海報式非對稱構圖，首頁主視覺由大字敘事與新竹實景共同構成；問卷採單欄紙本工作軸；後台採固定工作列、非對稱資訊板與方正資料表。首頁依「主視覺與成果統計→進行中調查→代表團使命與主要參與入口→常見問題」組織。頁面內容在 JavaScript 或捲動觀察器未執行時仍必須可見，題目在 320px 寬度必須安全換行，互動控制需有清楚的鍵盤焦點與行動版觸控區。
